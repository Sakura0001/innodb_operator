...
-- 测试单列索引 int_col 下从 C 插入10万行 INSERT SELECT * 的执行情况
...
ALTER TABLE `{{TEST_TABLE_NAME}}` ADD INDEX `idx_insert_single_int` (`int_col`);
