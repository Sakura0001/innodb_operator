-- CREATE SPATIAL INDEX `idx_sp_polygon_point_multi` ON `{{TEST_TABLE_NAME}}` (`polygon_multi_col`, `point_multi_col`);
-- 测试 CREATE SPATIAL INDEX作用于 polygon 与 point 多列组合时的报错记录
