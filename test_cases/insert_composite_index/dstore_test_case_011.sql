-- INSERT INTO `{{TEST_TABLE_NAME}}` SELECT * FROM `{{TEST_TABLE_NAME}}_src` WHERE `int_col` % 2 = 0;
-- 测试组合索引下从 C 插入1万行WHERE int_col 模2的执行情况
