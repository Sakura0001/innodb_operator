-- INSERT INTO `{{TEST_TABLE_NAME}}` SELECT * FROM (SELECT * FROM `{{TEST_TABLE_NAME}}_src` LIMIT 8000) t;
-- 测试唯一索引下从 C 插入1万行派生表 1万的执行情况
