-- INSERT INTO `{{TEST_TABLE_NAME}}` SELECT * FROM `{{TEST_TABLE_NAME}}_src`;
-- 测试唯一索引 varchar_col 下从 C 插入1万行 INSERT SELECT * 的执行情况
